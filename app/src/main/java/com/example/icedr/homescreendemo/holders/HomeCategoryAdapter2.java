...
public class HomeCategoryAdapter2 extends RecyclerView.Adapter<HomeCategoryAdapter2.MegaHolder> {

    @Override
    public MegaHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MegaHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_2, parent, false));
    }
