...
public class HomeCategoryAdapter3 extends RecyclerView.Adapter<HomeCategoryAdapter3.MegaHolder> {

    @Override
    public MegaHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MegaHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_3, parent, false));
    }
